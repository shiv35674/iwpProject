            ...
            <?php
                ...
                {   
                    ...
                    // Connect to the database
                        ...
                        $result = mysqli_query($con,"SELECT * FROM ph where phUser='".$username."' and phPass='".$password."';") or die("Failed to Login".mysql_error());
                                $row = mysqli_fetch_array($result);
                                if($row["phUser"]==$username && $row["phPass"]==$password)
                                {
                                    echo "<script> window.location.href='phhome.php';</script>" ;
                                }

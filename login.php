...
<!--             <img src="img/drug-icon-2316244_640.png"  height="160" width="160"> <br>-->
      ...
      <h1 style="margin-bottom:25px;font-weight:bold;color:black;" >Customer</h1>
      <hr style="border-top: 1px solid black;">
			  ...
			  <div class="form-group">
				<label for="upass" style="margin-top:30px;font-weight: bold;color: #000000;margin-bottom:15px;margin:auto;font-size:30px;">Password:</label>
        ...
        <br><br>
        <a href="login1.php" style="font-weight: bold;color: black;">Login as Pharmacist</a><br>
			  <br>
            ...
            <?php
                ...
                {   
                    ...
                    // Connect to the database
                        ...
                        {
                            echo "<script> window.location.href='cushome.php';</script>" ;
                        }

                        else
                        {
                            
                            // $result1 = mysqli_query($con,"SELECT * FROM admin where aUserName='".$username."' and aPassword='".$password."';") or die("Failed to Login".mysql_error());
                            //     $row1 = mysqli_fetch_array($result1);
                            //     if($row1['aUserName']==$username && $row1['aPassword']==$password)
                            //     {
